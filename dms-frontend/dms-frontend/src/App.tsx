...
import PlantMovementsPage from "@/pages/PlantMovementsPage";
    ...
    <PermissionProvider>
      <Routes>
        <Route element={<MainLayout />}>
          ...
          <Route path="/plant-movements" element={<ProtectedRoute module="PlantMovements"><PlantMovementsPage /></ProtectedRoute>} />
