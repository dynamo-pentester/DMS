    ...
    : IdentityDbContext<ApplicationUser, IdentityRole<int>, int>, IApplicationDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Endorsement>().HasData(
            new Endorsement { EndorsementId = 1, Name = "Hazmat" },
            new Endorsement { EndorsementId = 2, Name = "Passenger" },
            new Endorsement { EndorsementId = 3, Name = "Tanker" },
            new Endorsement { EndorsementId = 4, Name = "Air Brakes" }
        );
