...
const typeConfig: Record<string, { icon: string; color: string; bg: string; darkBg: string }> = {
  License:         { icon: "🪪", color: "text-amber-700", bg: "bg-amber-50",   darkBg: "dark:bg-amber-900/20" },
  Medical:         { icon: "🏥", color: "text-rose-700",  bg: "bg-rose-50",    darkBg: "dark:bg-rose-900/20" },
  Training:        { icon: "📋", color: "text-blue-700",  bg: "bg-blue-50",    darkBg: "dark:bg-blue-900/20" },
  Incident:        { icon: "⚠️", color: "text-orange-700",bg: "bg-orange-50",  darkBg: "dark:bg-orange-900/20" },
  Document:        { icon: "🗂️", color: "text-indigo-700",bg: "bg-indigo-50",  darkBg: "dark:bg-indigo-900/20" },
  System:          { icon: "⚙️", color: "text-slate-700", bg: "bg-slate-50",   darkBg: "dark:bg-slate-800/50" },
              ...
              <div key={n.notificationId}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-2 flex items-center gap-3">
                    ...
                    <button onClick={() => dismiss(n.notificationId)} className="text-xs font-semibold text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-300">
                      Dismiss
                    </button>
                  </div>
                </div>
